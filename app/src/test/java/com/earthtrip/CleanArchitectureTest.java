...
class CleanArchitectureTest {
    ...
    @ArchTest
    static final ArchRule INBOUND_DOES_NOT_DEPEND_ON_OUTBOUND = noClasses()
        .that()
    ...
    @ArchTest
    static final ArchRule INBOUND_DOES_NOT_DEPEND_ON_DOMAIN = noClasses()
        .that()
        .resideInAPackage("..adapter.in..")
        .should()
        .dependOnClassesThat()
    ...
    @ArchTest
    static final ArchRule OUTBOUND_DOES_NOT_DEPEND_ON_INBOUND_OR_SERVICES = noClasses()
        .that()
        .resideInAPackage("..adapter.out..")
        .should()
        .dependOnClassesThat()
    ...
    @ArchTest
    static final ArchRule QUERYDSL_STAYS_IN_PERSISTENCE_SUPPORT = noClasses()
        .that()
    ...
    @ArchTest
    static final ArchRule IMPLEMENTATION_TYPES_ARE_PACKAGE_PRIVATE = noClasses()
        .that()
        .resideInAnyPackage("..adapter.in..", "..application.service..")
        .should()
        .bePublic();
    ...
    @ArchTest
    static final ArchRule PERSISTENCE_IMPLEMENTATIONS_ARE_PACKAGE_PRIVATE = noClasses()
        .that()
