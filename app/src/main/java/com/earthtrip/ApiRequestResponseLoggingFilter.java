...
final class ApiRequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    ApiRequestResponseLoggingFilter(
        ...
        @Value("${earthtrip.logging.http.max-payload-bytes:65536}") int maxPayloadBytes
    ) {
    ...
    protected void doFilterInternal(
        ...
        CapturingHttpServletResponseWrapper responseWrapper =
            new CapturingHttpServletResponseWrapper(response, maxPayloadBytes);
    ...
    private void writeExchangeLog(
        ...
        try {
            ...
            String traceId = request.getAttribute(TRACE_ID_ATTRIBUTE) instanceof String value
                ? value
                : "unknown";
    ...
    private static final class LimitedContentCachingRequestWrapper
        ...
        private LimitedContentCachingRequestWrapper(
            HttpServletRequest request,
            int cacheLimit
        ) {
