...
class IntegrationSyncJpaEntity {
    @Id
    ...
    protected IntegrationSyncJpaEntity() {}

    IntegrationSyncJpaEntity(IntegrationStorePort.SyncRecord r, String q, String s) {
        id = r.id().toString();
        userId = r.userId().toString();
        connectionId = r.connectionId() == null ? null : r.connectionId().toString();
    ...
    void apply(IntegrationStorePort.SyncRecord r, String q, String s) {
        status = r.status();
        request = q;
        result = s;
    ...
    IntegrationStorePort.SyncRecord record(Map<String, Object> q, Map<String, Object> s) {
        return new IntegrationStorePort.SyncRecord(
                UUID.fromString(id),
                UUID.fromString(userId),
                connectionId == null ? null : UUID.fromString(connectionId),
