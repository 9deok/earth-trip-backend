...
public interface ExternalAccountProviderPort {
    ...
    default void deleteCalendar(CalendarDeleteCommand command) {
        throw new UnsupportedOperationException("Calendar deletion is not supported");
    }
    ...
    record AuthorizationResult(Set<String> grantedScopes, Map<String, Object> protectedMetadata) {}
    ...
    record CalendarDeleteCommand(
            Map<String, Object> protectedMetadata, Map<String, Object> scopeConfig) {}
    ...
    record CalendarSyncResult(
            Map<String, Object> scopeConfig, int created, int updated, int deleted) {}
}
