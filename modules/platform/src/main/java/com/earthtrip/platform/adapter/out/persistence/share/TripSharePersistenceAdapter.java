...
class TripSharePersistenceAdapter implements TripShareStorePort {
    ...
    @Override
    public List<ShareRecord> findAll(UUID tripId) {
    ...
    @Override
    public Optional<ShareRecord> findByTokenHash(String tokenHash) {
