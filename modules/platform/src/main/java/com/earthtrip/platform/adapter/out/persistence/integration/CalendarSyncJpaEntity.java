...
@Entity
@Table(name = "trip_calendar_syncs")
class CalendarSyncJpaEntity {
    @Id
    ...
    @Column(name = "scope_config", columnDefinition = "JSON")
    String scope;
    ...
    protected CalendarSyncJpaEntity() {}

    CalendarSyncJpaEntity(IntegrationStorePort.CalendarRecord r, String s) {
    ...
    void apply(IntegrationStorePort.CalendarRecord r, String s) {
    ...
    IntegrationStorePort.CalendarRecord record(Map<String, Object> s) {
