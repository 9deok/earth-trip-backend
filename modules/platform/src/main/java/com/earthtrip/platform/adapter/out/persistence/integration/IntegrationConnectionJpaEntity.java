...
class IntegrationConnectionJpaEntity {
    @Id
    ...
    @Column(name = "connection_kind", length = 30)
    String kind;
    ...
    @Column(name = "authorization_state", length = 120)
    ...
    IntegrationConnectionJpaEntity(IntegrationStorePort.ConnectionRecord r, String s, String m) {
        id = r.id().toString();
    ...
    void apply(IntegrationStorePort.ConnectionRecord r, String s, String m) {
        status = r.status();
        scopes = s;
        metadata = m;
    ...
    IntegrationStorePort.ConnectionRecord record(Set<String> s, Map<String, Object> m) {
