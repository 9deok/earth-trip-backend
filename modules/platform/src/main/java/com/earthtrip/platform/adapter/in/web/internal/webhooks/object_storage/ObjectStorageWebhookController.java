package com.earthtrip.platform.adapter.in.web.internal.webhooks.object_storage;
...
@RestController
@RequestMapping("/internal/webhooks/object-storage")
class ObjectStorageWebhookController {

    private final InternalOperationsUseCase useCase;

    ObjectStorageWebhookController(InternalOperationsUseCase useCase) {
    ...
    InternalOperationsUseCase.WebhookResult post(
        ...
        return useCase.acceptWebhook("object-storage", eventId, timestamp, signature, rawBody);
    }
}
