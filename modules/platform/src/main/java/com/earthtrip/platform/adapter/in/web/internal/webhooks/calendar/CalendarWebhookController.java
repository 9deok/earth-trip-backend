package com.earthtrip.platform.adapter.in.web.internal.webhooks.calendar;
...
@RestController
@RequestMapping("/internal/webhooks/calendar")
class CalendarWebhookController {

    private final InternalOperationsUseCase useCase;

    CalendarWebhookController(InternalOperationsUseCase useCase) {
