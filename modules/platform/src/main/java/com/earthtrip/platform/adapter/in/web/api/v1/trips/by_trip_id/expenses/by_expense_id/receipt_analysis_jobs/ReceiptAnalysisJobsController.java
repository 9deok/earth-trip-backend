package com.earthtrip.platform.adapter.in.web.api.v1.trips.by_trip_id.expenses.by_expense_id.receipt_analysis_jobs;
...
@RestController
@RequestMapping("/api/v1/trips/{tripId}/expenses/{expenseId}/receipt-analysis-jobs")
