...
class WalletRecordJpaEntity {
    ...
    protected WalletRecordJpaEntity() {}

    WalletRecordJpaEntity(WalletRecord r, String json) {
        id = r.id().toString();
        apply(r, json);
    }

    void apply(WalletRecord r, String json) {
    ...
    WalletRecord toDomain(Map<String, Object> data) {
        return WalletRecord.restore(
                UUID.fromString(id),
