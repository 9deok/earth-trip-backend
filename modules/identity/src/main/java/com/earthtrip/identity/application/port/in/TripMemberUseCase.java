...
public interface TripMemberUseCase {
    ...
    MemberResult changeRole(UUID tripId, UUID memberId, UUID actorUserId, String role, long baseVersion);
    ...
    record MemberResult(
        UUID memberId, UUID userId, String displayName, String email, String role,
        String status, boolean currentUser, Instant joinedAt, long version
    ) { }
}
