...
@Entity @Table(name = "ownership_transfers")
class OwnershipTransferJpaEntity {
    ...
    @Column(name = "from_user_id", nullable = false, length = 36) private String fromUserId;
    @Column(name = "to_user_id", nullable = false, length = 36) private String toUserId;
    ...
    OwnershipTransferJpaEntity(
        ...
        this.id = id.toString(); this.tripId = tripId.toString();
        this.fromUserId = fromUserId.toString(); this.toUserId = toUserId.toString();
        this.confirmedAt = confirmedAt; this.createdAt = confirmedAt;
    }
}
