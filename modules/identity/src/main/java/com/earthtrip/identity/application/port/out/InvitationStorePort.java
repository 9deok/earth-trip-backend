...
public interface InvitationStorePort {
    ...
    record InvitationRecord(
        UUID id, UUID tripId, String email, String role, String tokenHash, String status,
        UUID invitedBy, UUID invitedUserId, Instant expiresAt, Instant acceptedAt,
        Instant declinedAt, Instant revokedAt, Instant lastDeliveredAt, String deliveryStatus,
