...
public interface InvitationUseCase {
    ...
    CreatedInvitation create(UUID tripId, UUID actorUserId, UUID requestId, String email, String role);
    InvitationResult update(UUID tripId, UUID invitationId, UUID actorUserId, String role, Instant expiresAt, long baseVersion);
    ...
    record InvitationResult(
        UUID invitationId, UUID tripId, String email, String role, String status,
        Instant expiresAt, String deliveryStatus, Instant lastDeliveredAt,
