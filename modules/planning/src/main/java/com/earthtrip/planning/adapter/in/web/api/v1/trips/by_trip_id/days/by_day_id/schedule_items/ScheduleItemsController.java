...
@RestController
@RequestMapping("/api/v1/trips/{tripId}/days/{dayId}/schedule-items")
class ScheduleItemsController {
    private final ScheduleUseCase useCase;
    private final CurrentActor actor;

    ScheduleItemsController(ScheduleUseCase u, CurrentActor a) {
        useCase = u;
        actor = a;
    }
    ...
    PlanningResourceUseCase.ResourceResult post(
        ...
        return useCase.create(
                ...
                new PlanningResourceUseCase.ResourceCommand(
                        r.requestId(), dayId, null, r.payload(), r.status(), r.sortOrder(), 0));
    }
}
