...
public interface DestinationCandidateUseCase {
    ...
    CandidateResult update(UUID tripId, UUID candidateId, UUID actorUserId, CandidateCommand command);
    void delete(UUID tripId, UUID candidateId, UUID actorUserId, long baseVersion);
    PreferenceResult putPreference(UUID tripId, UUID candidateId, UUID actorUserId, String preference);
    void deletePreference(UUID tripId, UUID candidateId, UUID actorUserId);

    record CandidateCommand(
        UUID requestId, String name, String countryCode, String placeId, BigDecimal latitude,
        BigDecimal longitude, String note, String status, long baseVersion
    ) { }
    ...
    record CandidateResult(
        ...
        List<PreferenceResult> preferences, long version, UUID createdBy,
