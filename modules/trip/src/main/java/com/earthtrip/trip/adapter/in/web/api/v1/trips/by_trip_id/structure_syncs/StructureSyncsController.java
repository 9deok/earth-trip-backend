package com.earthtrip.trip.adapter.in.web.api.v1.trips.by_trip_id.structure_syncs;
...
@RestController
@RequestMapping("/api/v1/trips/{tripId}/structure-syncs")
class StructureSyncsController {

    private final TripStructureUseCase useCase;
    private final CurrentActor actor;

    StructureSyncsController(TripStructureUseCase useCase, CurrentActor actor) {
