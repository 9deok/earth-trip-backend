...
class TripSegmentByIdController {
    ...
    TripSegmentResponse patch(
        ...
        return response(useCase.update(
            tripId, segmentId, currentActor.requireUserId(),
            new TripSegmentUseCase.SegmentCommand(
                segmentId, r.type(), r.cityName(), r.countryCode(), r.placeId(), r.latitude(),
...
record TripSegmentUpdateRequest(
    @NotBlank String type, String cityName, String countryCode, String placeId,
    BigDecimal latitude, BigDecimal longitude, @NotNull LocalDate startDate, @NotNull LocalDate endDate,
    String accommodationName, String accommodationPlaceId, Instant checkInAt, Instant checkOutAt,
    String transportMode, Instant departureAt, Instant arrivalAt, @Min(0) Integer sortOrder,
